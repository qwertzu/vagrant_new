...
class Management < VagrantTest::Service
  ...
  class << self
    ...
    def init
      ...
      exec_home('mysql -u'+Settings.mysql_username+' -p'+Settings.mysql_password+' -e "drop database deal_management_vagrant"')
